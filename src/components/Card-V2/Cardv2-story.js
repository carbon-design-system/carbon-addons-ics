...
const mediaSrc = 'https://www.ibm.com/images/portal/U348822E90543V80/cognitive-bg-1600x900-1.jpg';
const mediaAlt = 'example image';

storiesOf('Components|Card-V2', module)
  .addDecorator(withReadme(readme))
  .addDecorator(story => <div className="bx--col-sm-6 bx--col-lg-3">{story()}</div>)
  .add(
    'default',
    withInfo(
      `
    ...
    `,
      ...
      <Cardv2 {...cardProps}>
        ...
        <CardText className="some-class">
          <p>
            This card is an example of how a card might appear but can be updated and modified to
            display any data that is needed within the context of your product.
          </p>
        </CardText>
      </Cardv2>
    )),
