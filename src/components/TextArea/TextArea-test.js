...
describe('TextArea', () => {
  describe('should render as expected', () => {
    const wrapper = mount(<TextArea id="testing" labelText="testlabel" className="extra-class" />);
  ...
  describe('events', () => {
    describe('disabled textarea', () => {
      ...
      const wrapper = shallow(
        <TextArea id="test" labelText="testlabel" onClick={onClick} onChange={onChange} disabled />,
      );
    ...
    describe('enabled textarea', () => {
      ...
      const wrapper = shallow(
        <TextArea id="test" labelText="testlabel" onClick={onClick} onChange={onChange} />,
      );
